...
public class Actividades {
    ...
    public String toString() {
        return "Actividades{" + "titulo_actividad=" + titulo_actividad + ", tipo_actividad=" + tipo_actividad + ", numeroalumnos=" + numeroalumnos + ", comentarios=" + comentarios + ", previsto=" + previsto + ", medio_transporte=" + medio_transporte + ", alojamiento=" + alojamiento + ", fechaini=" + fechaini + ", fechafn=" + fechafn + ", horaini=" + horaini + ", horafn=" + horafn + ", departamento=" + departamento + '}';
    }
